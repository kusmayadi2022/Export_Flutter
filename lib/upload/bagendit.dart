    ...
    return Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              // informasibagendit4YR (39:97)
              margin: EdgeInsets.fromLTRB(26*fem, 0*fem, 28*fem, 8*fem),
              width: double.infinity,
              height: 684*fem,
              child: Stack(
                children: [
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Align(
                        // screenshot20230628at17291C2M (39:99)
                        alignment: Alignment.topCenter,
                        child: SizedBox(
                          width: 366*fem,
                          height: 161*fem,
                          child: Image.asset(
                            'assets/upload/images/screen-shot-2023-06-28-at-1729-1.png',
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
                  ...
                  Positioned(
                    // situbagenditsitubagenditatauda (39:101)
                    left: 19*fem,
                    top: 189*fem,
                    child: Align(
                      child: SizedBox(
                  ...
                  Positioned(
                    ...
                    child: Align(
                      child: SizedBox(
                        ...
                        height: 9*fem,
                        child: Image.asset(
                          'assets/upload/images/ellipse-2-cem.png',
                          width: 10*fem,
                          height: 9*fem,
                        ),
                      ),
            ...
            Container(
              // autogroupj8spEsT (3f2FS4YbM7V8yK1FErj8sP)
              width: 411*fem,
              height: 119*fem,
              child: Image.asset(
                'assets/upload/images/auto-group-j8sp.png',
                width: 411*fem,
                height: 119*fem,
              ),
            ),
